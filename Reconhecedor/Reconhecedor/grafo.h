...
*		- Ponteiro para endere?o do grafo a ser criado, podendo ser inexistente, com tipo struct grafo.
*
*	Assertivas de sa?da:
...
*		  iniciados como NULL e condi??o de retorno OK retornada.
*		- Grafo destruido, anteriormente referenciado pelo ponteiro de endere?o passado 
*		  como parametro, caso j? existia um grafo nesse endere?o e novo grafo vazio criado, com condicao de
...
*
*	Assertivas de sa?da:
*		- Nada foi modificado e condi??o de retorno OK retornada, caso vertice inexistente.
*		- Nada foi modificado e condi??o de retorno Grafo Nao Existe retornada, caso grafo inexistente.
...
*
*	Assertivas de sa?da:
*		- Nada foi modificado e condi??o de retorno OK retornada, caso aresta inexistente.
*		- Nada foi modificado e condi??o de retorno Grafo Nao Existe retornada, caso grafo inexistente.
*		- Nada foi modificado e condi??o de retorno OK retornada, caso par ordenado de chaves da aresta, passada como parametro,
*		  ja existia no grafo.
